                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/shrirammithe"
                                ...
                                <li>
                                    <Link to="Linkdin:https://www.linkedin.com/in/shriram-mithe" className="hover:underline hover:text-orange-500 ">
                                    Linkdin
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase">MyServices</h2>
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
